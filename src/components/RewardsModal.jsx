...
export const RewardsModal = ({ isOpen, onClose, onRewardRedeemed }) => {
  ...
  const rewards = [
    ...
    },
    {
      ...
      description: 'Get 10% discount on your next order (up to $50 off)',
      cost: 100,
      type: 'discount',
      value: 10,
      icon: Percent,
    ...
    },
    {
      ...
      description: 'Get 20% discount on your next order (up to $100 off)',
      cost: 200,
      type: 'discount',
      value: 20,
      icon: Percent,
    ...
    },
    {
      ...
      description: 'Get $25 credit to spend on any products',
      cost: 250,
      type: 'cashback',
      value: 25,
      icon: Gift,
    ...
    },
    {
      ...
      description: 'Get $50 credit to spend on any products',
      cost: 500,
      type: 'cashback',
      value: 50,
      icon: Gift,
    ...
    },
    {
      ...
      description: 'Free eco-friendly starter kit worth $75 (bamboo products, reusable bags)',
      cost: 300,
      type: 'discount',
      value: 'bundle-75',
      icon: Gift,
    ...
    },
    {
      ...
      description: 'Free premium eco bundle worth $150 (organic skincare, bamboo kitchenware)',
      cost: 600,
      type: 'product',
      value: 'bundle-150',
      icon: Gift,
